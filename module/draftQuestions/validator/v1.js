module.exports = (req) => {
    ...
    let draftQuestionValidator = {
        create: function () {
            ...
            req.checkBody('draftFrameworkId').exists().withMessage("invalid draft framework id")
            req.checkBody('draftEvidenceMethodId').exists().withMessage("invalid draft evidence method id")
            req.checkBody("draftSectionId").exists().withMessage("invalid draft section id")
            req.checkBody("draftCriteriaId").exists().withMessage("invalid draft criteria id")
