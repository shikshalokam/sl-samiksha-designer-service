...
module.exports = {
    ...
    DRAFT_CRITERIA_CREATED: "Criteria created successfully.",
    DRAFT_CRITERIAS_FETCHED: "Criterias fetched successfully.",
    DRAFT_CRITERIAS_NOT_FOUND: "No criterias found.",
    DRAFT_CRITERIAS_UPDATED: "Criteria updated successfully.",
    DRAFT_CRITERIA_DELETED: "Criteria deleted successfully.",
    DRAFT_ECM_CREATED: "ECM created successfully.",
    DRAFT_ECM_FOUND: "Ecm fetched successfully.",
    DRAFT_ECM_NOT_FOUND: "No ecm found.",
    DRAFT_ECM_UPDATED: "ECM updated successfully.",
    DRAFT_ECM_DELETED: "ECM deleted successfully.",
    ...
    DRAFT_QUESTION_CREATED: "Question created successfully.",
    DRAFT_QUESTION_FETCHED: "Questions fetched successfully.",
    DRAFT_QUESTION_NOT_FOUND: "No questions found.",
    DRAFT_QUESTION_DETAILS_FETCHED: "Question details fetched successfully.",
    DRAFT_QUESTION_UPDATED: "Question updated successfully.",
    DRAFT_QUESTION_DELETED: "Question deleted successfully.",
    ENTITY_TYPE_FETCHED: "Entity type fetched successfully.",
    SECTION_CREATED: "Section created successfully.",
    SECTION_FETCHED: "Sections fetched successfully.",
    SECTION_NOT_FOUND: "No sections found.",
    SECTION_DETAILS_FETCHED: "Sections details fetched successfully.",
